            ...
            <div id='StickyTableHeader'> 
                <table className="banggia fixed-header">
                    <colgroup>
                        ...
                        <col className="show-on-mobile col-marketcap" />
                    ...
                    <thead>
                        ...
                        <th rowspan="2" className="cell-highlight sortable">Vốn hóa thị trường</th>
                        {/* <th rowspan="2" className="cell-highlight sortable">Trần</th>
                        <th rowspan="2" className="cell-highlight sortable">Sàn</th> */}
                        <th rowspan="3" className="sortable has-toggle relative	text-center" data-slider-group="accumulated">
                            <div>
                                <span data-slider-field="accumulatedVol" className="slidable">
                                    <span className="has-content"> % Giá <br></br>1 năm</span>
                                </span>
                            </div>
                        </th>
                        ...
                        <th colspan="5" className="cell-highlight">Giá</th>
                        <th colspan="2" rowspan="2"><span>Tổng KLGD</span></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <th colspan="2">                                
                                <div className="slidable w-full flex">
                                    <div className="sortable cell-1-2 has-content w-2/4 border-r border-454545 border-solid flex justify-center">
